...
if (!function_exists('load_compound_properties_ajax_handler')) {
    function load_compound_properties_ajax_handler()
    {
        // Verify nonce
        if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'load_compound_properties_nonce')) {
    ...
    add_action('wp_ajax_load_compound_properties', 'load_compound_properties_ajax_handler');
    add_action('wp_ajax_nopriv_load_compound_properties', 'load_compound_properties_ajax_handler');
}
